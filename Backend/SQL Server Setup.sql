...
CREATE TABLE IF NOT EXISTS `gamesimulationdb`.`gameteams` (
  ...
  INDEX `fk_games_has_teams_teams1_idx` (`teams_name` ASC) VISIBLE,
  INDEX `fk_games_has_teams_games1_idx` (`game_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `gamesimulationdb`.`turns` (
  ...
  `inputSolidPR` DOUBLE NULL DEFAULT NULL,
  `inputIdealPR` DOUBLE NULL DEFAULT NULL,
  ...
  `inputSolidVertriebspersonalInland` DOUBLE NULL DEFAULT NULL,
  `inputIdealVertriebspersonalInland` DOUBLE NULL DEFAULT NULL,
  `inputSolidVertriebspersonalAusland` DOUBLE NULL DEFAULT NULL,
  `inputIdealVertriebspersonalAusland` DOUBLE NULL DEFAULT NULL,
  ...
  `inputFertigungspersonal` DOUBLE NULL DEFAULT NULL,
  `inputPersonalentwicklung` DOUBLE NULL DEFAULT NULL,
  `inputGehaltsaufschlag` DOUBLE NULL DEFAULT NULL,
  `inputInvestitionenBGA` DOUBLE NULL DEFAULT NULL,
  `sumVerkaufspreisAusland` DOUBLE NULL DEFAULT NULL,
  `sumFETechnik` DOUBLE NULL DEFAULT NULL,
  `sumFEHaptik` DOUBLE NULL DEFAULT NULL,
  `sumProduktbewerbungInland` DOUBLE NULL DEFAULT NULL,
  `sumProduktbewerbungAusland` DOUBLE NULL DEFAULT NULL,
  `sumPR` DOUBLE NULL DEFAULT NULL,
  `sumLiefermengeSondermarkt` DOUBLE NULL DEFAULT NULL,
  `sumLiefermengeAusland` DOUBLE NULL DEFAULT NULL,
  `sumVertriebspersonalInland` DOUBLE NULL DEFAULT NULL,
  `sumVertriebspersonalAusland` DOUBLE NULL DEFAULT NULL,
  `sumBetriebsstoffe` DOUBLE NULL DEFAULT NULL,
  `sumMaterialS` DOUBLE NULL DEFAULT NULL,
  `sumMaterialI` DOUBLE NULL DEFAULT NULL,
  ...
  INDEX `team_name` (`team_name` ASC) VISIBLE,
